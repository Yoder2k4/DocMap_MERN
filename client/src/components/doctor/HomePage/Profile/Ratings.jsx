			...
			<div className="flex-grow flex flex-col justify-center items-center">
				<div className="flex items-center my-1 w-full">
					...
					<div className="w-3/4 h-4 mx-4 bg-gray-200 rounded dark:bg-gray-700">
						<div className="h-4 bg-yellow-300 rounded w-[70%]"></div>
					</div>
				...
				<div className="flex items-center my-1 w-full">
					...
					<div className="w-3/4 h-4 mx-4 bg-gray-200 rounded dark:bg-gray-700">
						<div className="h-4 bg-yellow-300 rounded w-[40%]"></div>
					</div>
					<span className="text-sm font-medium text-gray-500 dark:text-gray-400">
						40%
					</span>
				...
				<div className="flex items-center my-1 w-full">
					...
					<div className="w-3/4 h-4 mx-4 bg-gray-200 rounded dark:bg-gray-700">
						<div className="h-4 bg-yellow-300 rounded w-[10%]"></div>
					</div>
					<span className="text-sm font-medium text-gray-500 dark:text-gray-400">
						10%
					</span>
				...
				<div className="flex items-center my-1 w-full">
					...
					<div className="w-3/4 h-4 mx-4 bg-gray-200 rounded dark:bg-gray-700">
						<div className="h-4 bg-yellow-300 rounded w-[50%]"></div>
					</div>
					<span className="text-sm font-medium text-gray-500 dark:text-gray-400">
						50%
					</span>
